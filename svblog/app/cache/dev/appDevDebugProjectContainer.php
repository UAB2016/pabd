...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BloggerBlogBundle', ($this->targetDirs[2].'/Resources/BloggerBlogBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BloggerBlogBundle', ($this->targetDirs[3].'\\src\\Blogger\\BlogBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['assetic.filter.yui_css'] = $instance = new \Assetic\Filter\Yui\CssCompressorFilter(($this->targetDirs[2].'/Resources/java/yuicompressor-2.4.6.jar'), 'C:\\ProgramData\\Oracle\\Java\\javapath\\java.EXE');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3307, 'dbname' => 'svblog', 'user' => 'root', 'password' => 'taticu', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ac11535f08352c4b209c6ffe3b2e6dd2827f2075309cc125273b795a55f9a271');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('vasipos');
        $a->setPassword('Parola mea');
        $a->setAuthMode('login');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'AsseticBundle', 6 => 'DoctrineMigrationsBundle', 7 => 'DoctrineBundle', 8 => 'DoctrineFixturesBundle', 9 => 'SensioFrameworkExtraBundle', 10 => 'AppBundle', 11 => 'BloggerBlogBundle', 12 => 'DebugBundle', 13 => 'WebProfilerBundle', 14 => 'SensioDistributionBundle', 15 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0f8ef07dde730b6bf85d8e4313fc922914a44520');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('574c466c83e014.30773683')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3307,
            'database_name' => 'svblog',
            'database_user' => 'root',
            'database_password' => 'taticu',
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'vasipos',
            'mailer_password' => 'Parola mea',
            'secret' => '0f8ef07dde730b6bf85d8e4313fc922914a44520',
            'blogger_blog.emails.contact_email' => 'vasipos@gmail.com',
            ...
            'kernel.secret' => '0f8ef07dde730b6bf85d8e4313fc922914a44520',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'vasipos',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Parola mea',
            ...
            'assetic.filter.yui_css.jar' => ($this->targetDirs[2].'/Resources/java/yuicompressor-2.4.6.jar'),
